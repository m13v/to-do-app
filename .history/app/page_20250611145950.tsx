              ...
              <Table className="table-fixed w-full">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="w-[40px]" title="Status">S</TableHead>
                    <TableHead className="w-[40px]" title="Done">D</TableHead>
                    <TableHead 
                    ...
                    <TableHead className="w-[100px] text-right" title="Actions">Actions</TableHead>
                  </TableRow>
                </TableHeader>
