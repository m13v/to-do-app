...
import { Plus, Loader2, Sparkles, Send, X, Copy, ArrowUpDown, ArrowUp, ArrowDown, Search, Check } from 'lucide-react';
...
export default function Home() {
  ...
  const handleMouseMoveOnTable = (e: React.MouseEvent<HTMLTableElement>) => {
    ...
    rows.forEach((row, index) => {
      ...
      const relativeBottom = rect.bottom - tableRect.top;
